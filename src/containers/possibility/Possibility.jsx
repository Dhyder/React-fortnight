...
const Possibility = () => {
  return (
    <div className="fortnight__possibility section__padding" id='possibility'>
      <div className="fortnight__possibility-image">
        <img src={possibilityImage} alt="possibility" />
      </div>
      <div className="fortnight__possibility-content">
